...
int loading(), menu(), menusinopsis(), menunowplaying(), menucomingsoon(), menufilm(), avengers(), pikachu(), resetduduk(), tiketavenger(int xx, int yy, int c), printtiketavenger(int xx, int yy, int c), tiketpikachu(int xx, int yy, int c), printtiketpikachu(int xx, int yy, int c), bantuan(), getch();
